...
# Save plot
ggsave(filename = "D:/MASTER_FILES/PLOTS/seq4_150_rg_distribution.pdf", device = "pdf", 
       width = 4, height = 2, units = "in", dpi = 450)

# Save plot
ggsave(filename = "D:/MASTER_FILES/PLOTS/seq4_150_rg_distribution.png", device = "png", 
       width = 4, height = 2, units = "in", dpi = 450)
...
# Save plot
ggsave(filename = "D:/MASTER_FILES/PLOTS/seq4_150_rg_time_serie.pdf", device = "pdf", 
       width = 4, height = 1.5, units = "in", dpi = 450)

# Save plot
ggsave(filename = "D:/MASTER_FILES/PLOTS/seq4_150_rg_time_serie.png", device = "png", 
       width = 4, height = 1.5, units = "in", dpi = 450)
...
# Save plot
ggsave(filename = "D:/MASTER_FILES/PLOTS/seq4_400_rg_distribution.pdf", device = "pdf", 
       width = 4, height = 2, units = "in", dpi = 450)

# Save plot
ggsave(filename = "D:/MASTER_FILES/PLOTS/seq4_400_rg_distribution.png", device = "png", 
       width = 4, height = 2, units = "in", dpi = 450)
...
# Save plot
ggsave(filename = "D:/MASTER_FILES/PLOTS/seq4_400_rg_time_serie.pdf", device = "pdf", 
       width = 4, height = 1.5, units = "in", dpi = 450)

# Save plot
ggsave(filename = "D:/MASTER_FILES/PLOTS/seq4_400_rg_time_serie.png", device = "png", 
       width = 4, height = 1.5, units = "in", dpi = 450)
...
# Save plot
ggsave(filename = "D:/MASTER_FILES/PLOTS/seq4_1500_rg_distribution.pdf", device = "pdf", 
       width = 4, height = 2, units = "in", dpi = 450)

# Save plot
ggsave(filename = "D:/MASTER_FILES/PLOTS/seq4_1500_rg_distribution.png", device = "png", 
       width = 4, height = 2, units = "in", dpi = 450)
...
# Save plot
ggsave(filename = "D:/MASTER_FILES/PLOTS/seq4_1500_rg_time_serie.pdf", device = "pdf", 
       width = 4, height = 1.5, units = "in", dpi = 450)

# Save plot
ggsave(filename = "D:/MASTER_FILES/PLOTS/seq4_1500_rg_time_serie.png", device = "png", 
       width = 4, height = 1.5, units = "in", dpi = 450)

...
cider <- read.csv(file = "E:/ME/ALL/Project_IDP_D2P2/DATA/BASES DE DATOS/df_fret_hml_delta.csv", 
                  header = TRUE)
...
# Extraer datos de baja
cider <- cider[cider$Response == "Baja", ]
...
ggplot(data = cider, aes(x = kappa, y = mean_delta)) +
  ...
  annotate(geom = "text", y = 2, x = 0.13, label = paste("r = ", a)) +
  annotate(geom = "text", y = 2, x = 0.25, label = paste("p = ", b))

# Guardar gráfico
ggsave(filename = "D:/ME/ALL/Project_NN_proteins/PLOTS/CORR/LOW/kappa_vs_fret.pdf",
       device = "pdf", width = 4.5, height = 4, units = "in", dpi = 400)

# Guardar gráfico
ggsave(filename = "D:/ME/ALL/Project_NN_proteins/PLOTS/CORR/LOW/kappa_vs_fret.png",
...
# Guardar gráfico
ggsave(filename = "D:/ME/ALL/Project_NN_proteins/PLOTS/CORR/LOW/FCR_vs_fret.pdf",
       device = "pdf", width = 4.5, height = 4, units = "in", dpi = 400)

# Guardar gráfico
ggsave(filename = "D:/ME/ALL/Project_NN_proteins/PLOTS/CORR/LOW/FCR_vs_fret.png",
       device = "png", width = 4.5, height = 4, units = "in", dpi = 400)
...
ggplot(data = cider, aes(x = NCPR, y = mean_delta)) +
  ...
  annotate(geom = "text", y = 2, x = -0.18, label = paste("p = ", b))

# Guardar gráfico
ggsave(filename = "D:/ME/ALL/Project_NN_proteins/PLOTS/CORR/LOW/NCPR_vs_fret.pdf",
       device = "pdf", width = 4.5, height = 4, units = "in", dpi = 400)

# Guardar gráfico
ggsave(filename = "D:/ME/ALL/Project_NN_proteins/PLOTS/CORR/LOW/NCPR_vs_fret.png",
       device = "png", width = 4.5, height = 4, units = "in", dpi = 400)
...
ggplot(data = cider, aes(x = Hidropatia, y = mean_delta)) +
  ...
  theme(axis.title = element_text(size = 14),
        ...
        panel.grid = element_blank()) +
  coord_cartesian(ylim = c(-0.1, 2)) +
  annotate(geom = "text", y = 2, x = 2.05, label = paste("r = ", a)) +
  annotate(geom = "text", y = 2, x = 2.55, label = paste("p = ", b))

# Guardar gráfico
ggsave(filename = "D:/ME/ALL/Project_NN_proteins/PLOTS/CORR/LOW/Hidropatia_vs_fret.pdf",
       device = "pdf", width = 4.5, height = 4, units = "in", dpi = 400)

# Guardar gráfico
ggsave(filename = "D:/ME/ALL/Project_NN_proteins/PLOTS/CORR/LOW/Hidropatia_vs_fret.png",
       device = "png", width = 4.5, height = 4, units = "in", dpi = 400)



# Valor de correlación
a <- round(unname(cor.test(cider$mean_delta, cider$Desorden, method = "pearson")$estimate), 3)
...
ggplot(data = cider, aes(x = Desorden, y = mean_delta)) +
  ...
  theme(axis.title = element_text(size = 14),
        ...
        panel.grid = element_blank()) +
  coord_cartesian(ylim = c(-0.1, 2)) +
  annotate(geom = "text", y = 2, x = 0.67, label = paste("r = ", a)) +
  annotate(geom = "text", y = 2, x = 0.75, label = paste("p = ", b))

# Guardar gráfico
ggsave(filename = "D:/ME/ALL/Project_NN_proteins/PLOTS/CORR/LOW/disorder_vs_fret.pdf",
       device = "pdf", width = 4.5, height = 4, units = "in", dpi = 400)

# Guardar gráfico
ggsave(filename = "D:/ME/ALL/Project_NN_proteins/PLOTS/CORR/LOW/disorder_vs_fret.png",
       device = "png", width = 4.5, height = 4, units = "in", dpi = 400)
...
ggplot(data = cider, aes(x = IDR.length, y = mean_delta)) +
  ...
  annotate(geom = "text", y = 2, x = 103, label = paste("p = ", b))

# Guardar gráfico
ggsave(filename = "D:/ME/ALL/Project_NN_proteins/PLOTS/CORR/LOW/longitud_vs_fret.pdf",
       device = "pdf", width = 4.5, height = 4, units = "in", dpi = 400)

# Guardar gráfico
ggsave(filename = "D:/ME/ALL/Project_NN_proteins/PLOTS/CORR/LOW/longitud_vs_fret.png",
       device = "png", width = 4.5, height = 4, units = "in", dpi = 400)
...
# Guardar gráfico
ggsave(filename = "D:/ME/ALL/Project_NN_proteins/PLOTS/PCA/LOW/PCA_var_5_low.pdf",
       device = "pdf", width = 4.5, height = 3.5, units = "in", dpi = 400)

# Guardar gráfico
ggsave(filename = "D:/ME/ALL/Project_NN_proteins/PLOTS/PCA/LOW/PCA_var_5_low.png",
...
autoplot(kmeans(cider[15:19], 7), data = cider, size = 1.5) +
  theme_bw() +
  theme(axis.title = element_text(size = 14),
        axis.text = element_text(size = 12),
        panel.grid = element_blank()) +
...
autoplot(pam(cider[15:19], k = 2), frame = TRUE, frame.type = "norm") +
  ...
  theme(axis.title = element_text(size = 14),
        ...
        panel.grid = element_blank(), 
        legend.position = "none")  +
  scale_color_manual(values = c("#FF7F0E", "#17BECF")) +
  scale_fill_manual(values = c("#FF7F0E", "#17BECF"))


# Guardar gráfico
ggsave(filename = "D:/ME/ALL/Project_NN_proteins/PLOTS/PCA/LOW/clustering_pam_group.pdf",
       device = "pdf", width = 6, height = 4.5, units = "in", dpi = 400)

# Guardar gráfico
ggsave(filename = "D:/ME/ALL/Project_NN_proteins/PLOTS/PCA/LOW/clustering_pam_group.png",

...
ggplot(data = temp_150, aes(x = rg, y = ..ncount..)) +
  geom_histogram(fill = "#e37100", alpha = 0.8, color = "#000000", 
                 linewidth = 0.1, binwidth = temp_bins) +
...
# Save plot
ggsave(filename = "D:/MASTER_FILES/PLOTS/seq3_150_rg_distribution.pdf", device = "pdf", 
       width = 4, height = 2, units = "in", dpi = 450)

# Save plot
ggsave(filename = "D:/MASTER_FILES/PLOTS/seq3_150_rg_distribution.png", device = "png", 
       width = 4, height = 2, units = "in", dpi = 450)
...
# Save plot
ggsave(filename = "D:/MASTER_FILES/PLOTS/seq3_150_rg_time_serie.pdf", device = "pdf", 
       width = 4, height = 1.5, units = "in", dpi = 450)

# Save plot
ggsave(filename = "D:/MASTER_FILES/PLOTS/seq3_150_rg_time_serie.png", device = "png", 
       width = 4, height = 1.5, units = "in", dpi = 450)
...
# Save plot
ggsave(filename = "D:/MASTER_FILES/PLOTS/seq3_400_rg_distribution.pdf", device = "pdf", 
       width = 4, height = 2, units = "in", dpi = 450)

# Save plot
ggsave(filename = "D:/MASTER_FILES/PLOTS/seq3_400_rg_distribution.png", device = "png", 
       width = 4, height = 2, units = "in", dpi = 450)
...
# Save plot
ggsave(filename = "D:/MASTER_FILES/PLOTS/seq3_400_rg_time_serie.pdf", device = "pdf", 
       width = 4, height = 1.5, units = "in", dpi = 450)

# Save plot
ggsave(filename = "D:/MASTER_FILES/PLOTS/seq3_400_rg_time_serie.png", device = "png", 
       width = 4, height = 1.5, units = "in", dpi = 450)
...
# Save plot
ggsave(filename = "D:/MASTER_FILES/PLOTS/seq3_1500_rg_distribution.pdf", device = "pdf", 
       width = 4, height = 2, units = "in", dpi = 450)

# Save plot
ggsave(filename = "D:/MASTER_FILES/PLOTS/seq3_1500_rg_distribution.png", device = "png", 
       width = 4, height = 2, units = "in", dpi = 450)
...
# Save plot
ggsave(filename = "D:/MASTER_FILES/PLOTS/seq3_1500_rg_time_serie.pdf", device = "pdf", 
       width = 4, height = 1.5, units = "in", dpi = 450)

# Save plot
ggsave(filename = "D:/MASTER_FILES/PLOTS/seq3_1500_rg_time_serie.png", device = "png", 
       width = 4, height = 1.5, units = "in", dpi = 450)

...
ggplot(data = cider, aes(x = kappa, y = mean_delta)) +
  ...
  annotate(geom = "text", y = 2, x = 0.16, label = paste("p = ", b))

# Guardar gráfico
ggsave(filename = "D:/ME/ALL/Project_NN_proteins/PLOTS/CORR/HIGH/kappa_vs_fret.pdf",
       device = "pdf", width = 4.5, height = 4, units = "in", dpi = 400)

# Guardar gráfico
ggsave(filename = "D:/ME/ALL/Project_NN_proteins/PLOTS/CORR/HIGH/kappa_vs_fret.png",
...
# Guardar gráfico
ggsave(filename = "D:/ME/ALL/Project_NN_proteins/PLOTS/CORR/HIGH/FCR_vs_fret.pdf",
       device = "pdf", width = 4.5, height = 4, units = "in", dpi = 400)

# Guardar gráfico
ggsave(filename = "D:/ME/ALL/Project_NN_proteins/PLOTS/CORR/HIGH/FCR_vs_fret.png",
       device = "png", width = 4.5, height = 4, units = "in", dpi = 400)
...
ggplot(data = cider, aes(x = NCPR, y = mean_delta)) +
  ...
  theme(axis.title = element_text(size = 14),
        ...
        panel.grid = element_blank()) +
  coord_cartesian(ylim = c(-0.1, 2)) +
  annotate(geom = "text", y = 2, x = -0.14, label = paste("r = ", a)) +
  annotate(geom = "text", y = 2, x = -0.09, label = paste("p = ", b))

# Guardar gráfico
ggsave(filename = "D:/ME/ALL/Project_NN_proteins/PLOTS/CORR/HIGH/NCPR_vs_fret.pdf",
       device = "pdf", width = 4.5, height = 4, units = "in", dpi = 400)

# Guardar gráfico
ggsave(filename = "D:/ME/ALL/Project_NN_proteins/PLOTS/CORR/HIGH/NCPR_vs_fret.png",
       device = "png", width = 4.5, height = 4, units = "in", dpi = 400)
...
ggplot(data = cider, aes(x = Hidropatia, y = mean_delta)) +
  ...
  theme(axis.title = element_text(size = 14),
        ...
        panel.grid = element_blank()) +
  coord_cartesian(ylim = c(-0.1, 2)) +
  annotate(geom = "text", y = 2, x = 3.03, label = paste("r = ", a)) +
  annotate(geom = "text", y = 2, x = 3.40, label = paste("p = ", b))

# Guardar gráfico
ggsave(filename = "D:/ME/ALL/Project_NN_proteins/PLOTS/CORR/HIGH/Hidropatia_vs_fret.pdf",
       device = "pdf", width = 4.5, height = 4, units = "in", dpi = 400)

# Guardar gráfico
ggsave(filename = "D:/ME/ALL/Project_NN_proteins/PLOTS/CORR/HIGH/Hidropatia_vs_fret.png",
       device = "png", width = 4.5, height = 4, units = "in", dpi = 400)
...
ggplot(data = cider, aes(x = Desorden, y = mean_delta)) +
  ...
  theme(axis.title = element_text(size = 14),
        ...
        panel.grid = element_blank()) +
  coord_cartesian(ylim = c(-0.1, 2)) +
  annotate(geom = "text", y = 2, x = 0.63, label = paste("r = ", a)) +
  annotate(geom = "text", y = 2, x = 0.70, label = paste("p = ", b))

# Guardar gráfico
ggsave(filename = "D:/ME/ALL/Project_NN_proteins/PLOTS/CORR/HIGH/disorder_vs_fret.pdf",
       device = "pdf", width = 4.5, height = 4, units = "in", dpi = 400)

# Guardar gráfico
ggsave(filename = "D:/ME/ALL/Project_NN_proteins/PLOTS/CORR/HIGH/disorder_vs_fret.png",
       device = "png", width = 4.5, height = 4, units = "in", dpi = 400)
...
# Guardar gráfico
ggsave(filename = "D:/ME/ALL/Project_NN_proteins/PLOTS/CORR/HIGH/longitud_vs_fret.pdf",
       device = "pdf", width = 4.5, height = 4, units = "in", dpi = 400)

# Guardar gráfico
ggsave(filename = "D:/ME/ALL/Project_NN_proteins/PLOTS/CORR/HIGH/longitud_vs_fret.png",
       device = "png", width = 4.5, height = 4, units = "in", dpi = 400)
...
# Guardar gráfico
ggsave(filename = "D:/ME/ALL/Project_NN_proteins/PLOTS/PCA/HIGH/PCA_var_5_high.pdf",
       device = "pdf", width = 4.5, height = 3.5, units = "in", dpi = 400)

# Guardar gráfico
ggsave(filename = "D:/ME/ALL/Project_NN_proteins/PLOTS/PCA/HIGH/PCA_var_5_high.png",
...
autoplot(pam(cider[15:19], k = 2), frame = TRUE, frame.type = "norm", 
  ...
  theme(axis.title = element_text(size = 14),
        ...
        panel.grid = element_blank(), 
        legend.position = "none") +
  scale_color_manual(values = c("#BC00BC", "#00BC00")) +
  scale_fill_manual(values = c("#BC00BC", "#00BC00"))
  

# Guardar gráfico
ggsave(filename = "D:/ME/ALL/Project_NN_proteins/PLOTS/PCA/HIGH/clustering_pam_group.pdf",
       device = "pdf", width = 6, height = 4.5, units = "in", dpi = 400)

# Guardar gráfico
ggsave(filename = "D:/ME/ALL/Project_NN_proteins/PLOTS/PCA/HIGH/clustering_pam_group.png",
